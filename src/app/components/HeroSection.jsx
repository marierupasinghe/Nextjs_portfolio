...
const HeroSection = () => {
  return (
    <section className="lg:py-25 bg-black"> {/* Increased vertical padding */}
      <div className="flex flex-col items-center justify-center h-screen"> {/* Set to full screen height */}
        {/* Text Section */}
        <motion.div
        ...
        >
          <h1 className="text-white text-5xl sm:text-6xl lg:text-8xl font-extrabold leading-snug mb-6"> {/* Increased text size */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/Resume.pdf" // CV link to the public folder
              download="Dewmini_CV.pdf" // Optional: Sets a filename for download
